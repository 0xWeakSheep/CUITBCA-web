          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mt-12">
            {members
              ...
              .map((member, index) => {
                ...
                const hasImageArea = member.avatar || member.color;
                ...
                return (
                  ...
                  >
                    {/* Image Area - only show if avatar or color is provided */}
                    {hasImageArea && (
                      <div
                    ...
                    {/* Content Area - only show if there's any content */}
                    {(member.name || member.role || member.bio || (member.skills && member.skills.length > 0)) && (
